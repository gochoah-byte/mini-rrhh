...
import image1 from "../assets/IMG-20250924-WA0399.jpg";
...
export const mockEmployees: Employee[] = [
  ...
  { id: 5, name: "Sofía Ramírez", email: "sofia.ramirez@empresa.com", position: "Desarrolladora Backend", department: "Tecnología", salary: 10000, hireDate: "2023-02-14", status: "active", role: "employee", avatarUrl: "https://i.pravatar.cc/64?img=2" },
  { id: 6, name: "Gabriel Ochoa", email: "gabriel.ochoa@empresa.com", position: "Gerente de Ventas", department: "Ventas", salary: 9250, hireDate: "2019-08-01", status: "inactive", role: "employee", avatarUrl: image1 },
  { id: 7, name: "Luis Hernández", email: "luis.hernandez@empresa.com", position: "Diseñador UX/UI", department: "Tecnología", salary: 9000, hireDate: "2022-08-10", status: "active", role: "employee" },
