...
export const mockEmployees: Employee[] = [
  ...
  { id: 6, name: "Gabriel Ochoa", email: "gabriel.ochoa@empresa.com", position: "Gerente de Ventas", department: "Ventas", salary: 9250, hireDate: "2019-08-01", status: "inactive", role: "employee" },
